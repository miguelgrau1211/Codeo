...
export class DashboardComponent implements OnInit {
  ...
  battlePassRewards = signal<BattlePassReward[]>([
    ...
    { 
      level: 35, type: 'theme', value: 'Forest Zen', icon: '🌲', label: 'Forest Zen',
      themeVars: { '--primary-bg': '#101c10', '--secondary-bg': '#1a2a1a', '--accent-color': '#4ade80' }
    },
    { 
      level: 42, type: 'theme', value: 'Void Master', icon: '🔮', label: 'Void Master',
      themeVars: { '--primary-bg': '#020202', '--secondary-bg': '#0a0a0c', '--accent-color': '#8a2be2' }
    },
    { level: 50, type: 'coins', value: 5000, icon: '👑', label: '5000 Coins' },
  ]);
